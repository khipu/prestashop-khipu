...
class KhipuPaymentBankselectModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $khipu->setAgent('prestashop-khipu-2.2.1;;'.Tools::getShopDomainSsl(true, true) . __PS_BASE_URI__ .';;'.Configuration::get('PS_SHOP_NAME'));
    ...
    private function generate_khipu_bankselect($banks)
    {
        ...
        if(!$banks) {
            return "Error de comunicación con khipu.";
        }
